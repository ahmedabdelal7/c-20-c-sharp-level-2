...
namespace MyNameSpace
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            PropertyInfo property1 = myClassType.GetProperty("Property1");
            int Property1Value = (int)property1.GetValue(myClassInstance);
            ...
            method1.Invoke(myClassInstance, null);

            // Invoke Method2 with parameters using reflection
            object[] parameters = { 100, "Ahmed Abdel-Aal" };
